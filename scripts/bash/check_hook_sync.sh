...
echo "::error file=$PLUGIN_HOOK::This plugin's $PLUGIN_HOOK differs from the canonical copy in matomo-org/plugin-ci-workflows (diff above). Copy hooks/pre-push over it, or delete the file and point core.hooksPath at that repository."
exit 1
